...
from cryptopy.trader.ui import QtCore, QtGui, QtWidgets
from cryptopy.trader.ui.widget import (
    MsgCell,
    TimeCell,
    BaseMonitor
)
...
class PortfolioStrategyManager(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        """"""
        self.setWindowTitle("Porfolio Strategy")
        ...
        init_button = QtWidgets.QPushButton("Initiaize All Strategies")
...
class SettingEditor(QtWidgets.QDialog):
    ...
    def init_ui(self):
        ...
        if self.class_name:
            ...
            self.setWindowTitle(f"Edit：{self.strategy_name}")
            button_text = "Confirm"
