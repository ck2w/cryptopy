...
from cryptopy.trader.ui import QtCore, QtWidgets
from cryptopy.trader.event import EVENT_CONTRACT
from cryptopy.trader.object import ContractData
...
class RecorderManager(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        ...
        add_bar_button = QtWidgets.QPushButton("Add")
        ...
        add_tick_button = QtWidgets.QPushButton("Add")
        ...
        grid.addWidget(QtWidgets.QLabel("Bar Recorder"), 0, 0)
        grid.addWidget(add_bar_button, 0, 1)
        grid.addWidget(remove_bar_button, 0, 2)
        grid.addWidget(QtWidgets.QLabel("Tick Recorder"), 1, 0)
        grid.addWidget(add_tick_button, 1, 1)
        grid.addWidget(remove_tick_button, 1, 2)

        form = QtWidgets.QFormLayout()
        form.addRow("Local codes", self.symbol_line)
        form.addRow("Insert interval", self.interval_spin)
