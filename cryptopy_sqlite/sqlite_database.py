...
from cryptopy.trader.object import BarData, TickData
from cryptopy.trader.utility import get_file_path
from cryptopy.trader.database import (
    BaseDatabase,
    BarOverview,
    DB_TZ,
    convert_tz
...
class SqliteDatabase(BaseDatabase):
    ...
    def save_bar_data(self, bars: List[BarData]) -> bool:
        ...
        # turn BarData to dict format，and adjust time zone
        data = []
        ...
        # Use upsert to update data to database.
        with self.db.atomic():
    ...
    def save_tick_data(self, ticks: List[TickData]) -> bool:
        """Save TICK data"""
        # turn TickData to dict，and adjust time zone
        data = []
    ...
    def get_bar_overview(self) -> List[BarOverview]:
        """search K line overview info in database"""
    ...
    def init_bar_overview(self) -> None:
        """init K line overview info in database"""
        s: ModelSelect = (
            DbBarData.select(
                DbBarData.symbol,
                DbBarData.exchange,
