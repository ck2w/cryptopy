...
class OrderMonitor(BaseMonitor):
    ...
    def init_ui(self):
        ...
        self.setToolTip("Doudble click to cancel order")
...
class PositionMonitor(BaseMonitor):
    ...
    headers = {
        ...
        "direction": {"display": "Direction", "cell": DirectionCell, "update": False},
        "volume": {"display": "Volume", "cell": BaseCell, "update": True},
        "yd_volume": {"display": "Yestarday Volume", "cell": BaseCell, "update": True},
...
class AccountMonitor(BaseMonitor):
    ...
    headers = {
        "accountid": {"display": "Account", "cell": BaseCell, "update": False},
        "balance": {"display": "Balance", "cell": BaseCell, "update": True},
        "frozen": {"display": "Frozen", "cell": BaseCell, "update": True},
        "available": {"display": "Avaliable", "cell": BaseCell, "update": True},
        "gateway_name": {"display": "Gateway", "cell": BaseCell, "update": False},
    }
...
class QuoteMonitor(BaseMonitor):
    ...
    headers: Dict[str, dict] = {
        "quoteid": {"display": "Quote", "cell": BaseCell, "update": False},
        "reference": {"display": "Reference", "cell": BaseCell, "update": False},
        "symbol": {"display": "Symbol", "cell": BaseCell, "update": False},
        "exchange": {"display": "Exchange", "cell": EnumCell, "update": False},
        "bid_offset": {"display": "Bid Offer", "cell": EnumCell, "update": False},
...
class TradingWidget(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        ...
        self.price_check.setToolTip("Price Check")
    ...
    def send_order(self) -> None:
        ...
        symbol = str(self.symbol_line.text())
        if not symbol:
            QtWidgets.QMessageBox.critical(self, "Send Order Failed", "Please input symbol")
            return

        volume_text = str(self.volume_line.text())
        if not volume_text:
            QtWidgets.QMessageBox.critical(self, "Send Order Failed", "Please input volume")
            return
...
class ContractManager(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        """"""
        self.setWindowTitle("Volume Check")
